...
def get_interaction(id):
    ...
    return jsonify({'id': interaction.id, 'agent_id': interaction.agent_id, 'customer_id': interaction.customer_id, 'created_at': interaction.created_at, 'type': interaction.type, 'content': interaction.content})
...
@interaction_bp.route('/interactions/<id>', methods=['PUT'])
...
@interaction_bp.route('/interactions/<id>', methods=['DELETE'])
